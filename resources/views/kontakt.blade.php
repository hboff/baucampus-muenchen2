...
<body class="body">
  <div data-collapse="medium" data-animation="default" data-duration="400" data-w-id="9962d9cc-619f-1e92-7f2b-747f23a87122" data-easing="ease" data-easing2="ease" role="banner" class="navbar w-nav">
    <div class="container flex">
      ...
      <nav role="navigation" class="nav-menu w-nav-menu">
        ...
        <a href="kontakt" aria-current="page" class="nav-link w-nav-link w--current">Kontakt</a>
  ...
  <div data-w-id="4fdb7d98-c577-efa9-1720-b057e323bceb" class="dont-dilate_"></div>
  <div data-w-id="6fca50ab-de2f-362b-39cc-d7d7b0ef92d4" class="main-section contact-us wf-section">
    <div class="container">
        ...
        <div class="contact-content">
          ...
          <div class="div-block-6">
            <div id="w-node-_49967b82-f3e5-16b1-3011-09d3c34bc882-d9f271c1" class="contact-item">
              ...
              <a href="#" class="text-style-link-form">info@baucampus.de</a>
            </div>
            <div id="w-node-_49967b82-f3e5-16b1-3011-09d3c34bc887-d9f271c1" class="contact-item">
              <div class="contact-icon-wrapper">
                <div class="w-embed"><svg width="24" height="24" viewbox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <a href="#" class="text-style-link-form">+49 5722 913800</a>
            </div>
            <div id="w-node-_49967b82-f3e5-16b1-3011-09d3c34bc88c-d9f271c1" class="contact-item">
              <div class="contact-icon-wrapper">
                <div class="w-embed"><svg width="24" height="24" viewbox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <a href="#" class="text-style-link-form">Baucampus Deutschland</a>
            </div>
          </div>
        </div>
    ...
    <div class="contact-card-grid">
      ...
      <div id="w-node-_844c8045-9dde-5abb-8fa5-927042016036-d9f271c1" data-w-id="844c8045-9dde-5abb-8fa5-927042016036" class="contact-card">
        ...
        <a href="tel:+35391760711" class="contact-card-link">Walther Straße 18<br>80337 München<br> </a>
      </div>
