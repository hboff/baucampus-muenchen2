...
<html data-wf-page="648d0891096d52bfd9f271c7" data-wf-site="648d0891096d52bfd9f271dc" lang="fr">
<head>
  <meta charset="utf-8">
  <title>Earth and Mining</title>
  <meta content="Earth and Mining" property="og:title">
  <meta content="Earth and Mining" property="twitter:title">
...
<body class="body">
  ...
  <div data-w-id="6fca50ab-de2f-362b-39cc-d7d7b0ef92d4" class="main-section services wf-section">
    <div class="container relative">
      <div data-w-id="bf8531e1-198a-24de-4582-6d1ae146a6f6" style="opacity:0" class="bread-crumbs-wrapper">
        ...
        <div class="bread-crumbs active"> / </div>
        <div class="bread-crumbs active">Earth and Mining</div>
      </div>
      <h3 data-w-id="d3349579-0b18-6f19-95a4-d1bb8ad22c13" style="opacity:0" class="display-text">Earth and Mining</h3>
    </div>
    <div class="background-overlay"></div><img src="../images/2Photo_12Photo.webp" loading="lazy" sizes="100vw" srcset="../images/2Photo_1-p-500.png 500w, ../images/2Photo_1-p-800.png 800w, ../images/2Photo_12Photo.webp 1024w" alt="" class="background-img">
  </div>
  <div data-w-id="4c341b8b-2ef7-5a8c-1192-6185da71e66f" class="section sub-main wf-section">
    <div class="container">
      <div class="column-grid-post-main two">
        <div data-w-id="04297b0d-1249-7c77-a3e2-8c234f4ef296" style="opacity:0" class="card-name-text">Earth and Mining</div>
  ...
  <div data-w-id="6bb3502d-11a7-7305-cc26-615d8fce3ac0" class="section services wf-section">
    <div class="container max-1080-px">
      <div class="parallax-image-wrapper"><img src="../images/efrsd2.webp" sizes="(max-width: 479px) 100vw, (max-width: 767px) 95vw, 96vw" srcset="../images/efrsd2-p-500.webp 500w, ../images/efrsd2-p-800.webp 800w, ../images/efrsd2.webp 1024w" alt="" class="parallax-image second-img-for-service-page"></div>
      ...
      <div class="w-layout-grid grid-service-page">
        <div id="w-node-_2e19e198-f3de-3628-d31f-0c9184d0f60f-d9f271c7" class="layout-content">
          <div class="w-layout-grid layout-item-list">
            <div id="w-node-f248d2e1-f8fe-7be3-709a-e31a50034664-d9f271c7" class="layout-item">
            ...
            <div id="w-node-f248d2e1-f8fe-7be3-709a-e31a5003466c-d9f271c7" class="layout-item">
            ...
            <div id="w-node-f248d2e1-f8fe-7be3-709a-e31a50034674-d9f271c7" class="layout-item">
            ...
            <div id="w-node-f248d2e1-f8fe-7be3-709a-e31a5003467c-d9f271c7" class="layout-item">
        ...
        <div class="layout-image-wrapper">
          <a href="#" class="lightbox-second-page w-inline-block w-lightbox"><img src="../images/efz2.webp" width="1326" sizes="(max-width: 479px) 100vw, (max-width: 767px) 95vw, 96vw" srcset="../images/efz2-p-500.webp 500w, ../images/efz2-p-800.webp 800w, ../images/efz2.webp 1024w" alt="">
