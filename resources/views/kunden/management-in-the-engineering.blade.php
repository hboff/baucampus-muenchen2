...
<html data-wf-page="648d0891096d52bfd9f271cd" data-wf-site="648d0891096d52bfd9f271dc" lang="fr">
<head>
  <meta charset="utf-8">
  <title>Management in the Engineering</title>
  <meta content="Management in the Engineering" property="og:title">
  <meta content="Management in the Engineering" property="twitter:title">
...
<body class="body">
  ...
  <div data-w-id="6fca50ab-de2f-362b-39cc-d7d7b0ef92d4" class="main-section services wf-section">
    <div class="container relative">
      <div data-w-id="bf8531e1-198a-24de-4582-6d1ae146a6f6" style="opacity:0" class="bread-crumbs-wrapper">
        <a href="../index.html" class="bread-crumbs">Home</a>
        <div class="bread-crumbs active"> / </div>
        <a href="../leistungen.html" class="bread-crumbs">Service</a>
        <div class="bread-crumbs active"> / </div>
        <div class="bread-crumbs active">Management in the Engineering</div>
      </div>
      <h3 data-w-id="d3349579-0b18-6f19-95a4-d1bb8ad22c13" style="opacity:0" class="display-text">Management in the Engineering</h3>
    </div>
    <div class="background-overlay"></div><img src="../images/Management-in-the-Engineering-.webp" loading="lazy" sizes="100vw" srcset="../images/Management-in-the-Engineering--p-500.webp 500w, ../images/Management-in-the-Engineering--p-800.webp 800w, ../images/Management-in-the-Engineering-.webp 1024w" alt="" class="background-img">
  </div>
  <div data-w-id="4c341b8b-2ef7-5a8c-1192-6185da71e66f" class="section sub-main wf-section">
    <div class="container">
      <div class="column-grid-post-main two">
        <div data-w-id="04297b0d-1249-7c77-a3e2-8c234f4ef296" style="opacity:0" class="card-name-text">Management in the Engineering</div>
  ...
  <div data-w-id="6bb3502d-11a7-7305-cc26-615d8fce3ac0" class="section services wf-section">
    <div class="container max-1080-px">
      <div class="parallax-image-wrapper"><img src="../images/Qouleti.webp" sizes="(max-width: 479px) 91vw, (max-width: 767px) 95vw, 96vw" srcset="../images/Qouleti-p-500.webp 500w, ../images/Qouleti-p-800.webp 800w, ../images/Qouleti.webp 1024w" alt="" class="parallax-image second-img-for-service-page"></div>
      ...
      <div class="w-layout-grid grid-service-page">
        <div id="w-node-_2e19e198-f3de-3628-d31f-0c9184d0f60f-d9f271cd" class="layout-content">
          <div class="w-layout-grid layout-item-list">
            <div id="w-node-_00e969f9-6f6f-625a-51fb-eccdca7b6c6e-d9f271cd" class="layout-item">
            ...
            <div id="w-node-_00e969f9-6f6f-625a-51fb-eccdca7b6c76-d9f271cd" class="layout-item">
            ...
            <div id="w-node-_00e969f9-6f6f-625a-51fb-eccdca7b6c7e-d9f271cd" class="layout-item">
            ...
            <div id="w-node-_00e969f9-6f6f-625a-51fb-eccdca7b6c86-d9f271cd" class="layout-item">
          ...
          <div class="button-row">
            <a href="../kontakt.html" class="button-cta flat w-button">Get In Touch</a>
          </div>
        </div>
        <div class="layout-image-wrapper">
          <a href="#" class="lightbox-second-page w-inline-block w-lightbox"><img src="../images/2Photo_12Photo.webp" width="1326" sizes="(max-width: 479px) 91vw, (max-width: 767px) 95vw, 96vw" srcset="../images/2Photo_1-p-500.png 500w, ../images/2Photo_1-p-800.png 800w, ../images/2Photo_12Photo.webp 1024w" alt="">
