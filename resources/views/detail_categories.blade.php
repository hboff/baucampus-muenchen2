...
<html data-wf-page="648d0891096d52bfd9f271c3" data-wf-site="648d0891096d52bfd9f271dc" lang="fr">
<head>
  <meta charset="utf-8">
...
<body>
  ...
  <div data-w-id="d53fb2e9-d776-da0d-8620-23b4ecf3de2e" class="main-section news-page wf-section">
    <div class="container">
      <div>
        <div data-w-id="d53fb2e9-d776-da0d-8620-23b4ecf3de31" style="opacity:0" class="bread-crumbs-wrapper">
          <a href="index.html" class="bread-crumbs black">Home</a>
          <div class="bread-crumbs active"> / </div>
          <div class="bread-crumbs active">Latest News &amp; Updates</div>
        </div>
        <h3 data-w-id="d53fb2e9-d776-da0d-8620-23b4ecf3de38" style="opacity:0" class="display-text"></h3>
      </div>
    </div>
  </div>
  <div class="section wf-section">
    <div class="container">
      <div class="greed-wrapper-for-news">
        <div id="w-node-_84c4eef0-9c28-c962-91c2-3d1cdce603e9-d9f271c3" class="sticky-search-bar">
          <form action="/search" class="search w-form"><input type="search" class="search-input w-node-_84c4eef0-9c28-c962-91c2-3d1cdce603eb-d9f271c3 w-input" maxlength="256" name="query" placeholder="Search…" id="search" required=""><input type="submit" value="" class="search-button w-button"></form>
          ...
          <div class="recent-posts w-dyn-list">
            <div role="list" class="side-bar-collection w-dyn-items">
              <div role="listitem" class="w-dyn-item">
                <a href="#" class="recent-posts-card w-inline-block"><img id="w-node-_84c4eef0-9c28-c962-91c2-3d1cdce603f3-d9f271c3" src="" alt="" class="recent-posts-prew">
                  <div id="w-node-_84c4eef0-9c28-c962-91c2-3d1cdce603f4-d9f271c3">
                    <div>
        ...
        <div id="w-node-_84c4eef0-9c28-c962-91c2-3d1cdce60405-d9f271c3">
          <div class="w-dyn-list">
            <div role="list" class="grid-for-news-list w-dyn-items">
              <div id="w-node-_84c4eef0-9c28-c962-91c2-3d1cdce60408-d9f271c3" role="listitem" class="w-dyn-item">
                <div class="news-card"><img id="w-node-_84c4eef0-9c28-c962-91c2-3d1cdce6040a-d9f271c3" src="" alt="" class="news-prew">
                  <div id="w-node-_84c4eef0-9c28-c962-91c2-3d1cdce6040b-d9f271c3" class="wrapper-for-card-nrews">
                    <div>
                      <div class="small-thin-text"></div>
                      <div class="small-thin-text"> / </div>
                      <div class="small-thin-text"></div>
                    </div>
                    <div class="card-name-text blog">Donec vitae sapien venenatis</div>
                    <p></p>
                    <a href="#" class="button-main w-button">Read More</a>
                  </div>
                </div>
              </div>
            </div>
