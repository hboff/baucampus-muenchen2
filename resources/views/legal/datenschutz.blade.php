...
<html data-wf-page="6495f41126f620263a495833" data-wf-site="648d0891096d52bfd9f271dc" lang="fr">
<head>
  <meta charset="utf-8">
...
<body>
  ...
  <div class="section-2 legal wf-section">
      ...
      <div class="w-row">
        ...
        <div class="w-col w-col-7 w-col-stack">
          <div class="w-richtext">
            ...
            <p>Ihr Datenschutz ist uns ausgesprochen wichtig, daher erklären wir Ihnen: </p>
            <p>Daten aus Mails, Faxe oder per Post versandte Schriftstücken werden bei uns nicht extrahiert, um diese weiterzuverarbeiten. Wir geben keinerlei Daten aus unserem Geschäftsverkehr anderen bekannt, sofern es keine gesetzliche Pflicht dazu gibt (Strafverfolgungsbehörden, Steuerprüfung). Der Schriftverkehr wird bei uns nach steuer- und handelsrechtlichen Grundsätzen lediglich während der gesetzlichen Aufbewahrungsfrist archiviert. Nach Ablauf der gesetzlichen Fristen werden die Schriftstücke automatisch gelöscht bzw. vernichtet. </p>
            <p>‍</p>
            <p>Verantwortlicher für die Datenverarbeitung personenbezogener Daten bei Nutzung dieser Website ist:</p>
            <p>Casimir Arlabosse </p>
            <p>Walther Straße 15, </p>
            <p>80337 München, </p>
            <p>Telefon: 057222890636, </p>
            <p>E-Mail: arlabosse@baucampus.de </p>
            <p>‍</p>
            <p>Erfassung Anonymisierte Daten beim Besuch unserer Website. </p>
    ...
    <section class="section footer wf-section">
      <div class="container">
        <div class="footer-grid">
          ...
          <p id="w-node-_4aa0d7f3-2a4a-6a6b-69be-35f8e84120fd-e84120df" class="footer-text copyright">© 2023 Baucampus by <a href="https://ariet.is" target="_blank">Arietis </a>- <a href="../legal/impressum.html">Impressum</a> - <a href="../legal/datenschutz.html" aria-current="page" class="w--current">Datenschutz</a>
          </p>
