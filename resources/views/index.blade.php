...
<body>
      ...
      <div data-w-id="54adabf2-cbb8-69b7-1079-c5629eba736a" style="opacity:0" class="button-wrapper">
        ...
        <a href="#" data-w-id="54adabf2-cbb8-69b7-1079-c5629eba736d" style="opacity:0" class="lightbox-link w-inline-block w-lightbox">
          <div data-w-id="337f525a-79a0-edda-9bde-b1b29fb47704" class="crecl-icon-wrapper">
            ...
            <div class="cercl-figure two"></div>
            <div class="cercl-figure three"><img src="images/sgsf.svg" loading="lazy" width="10" alt=""></div>
          </div>
          <div>Unser Video!</div>
          <script type="application/json" class="w-json">{
  "items": [
    {
      "url": "https://youtube.com/watch?v=wmWT9FPdWw0",
      "originalUrl": "https://youtube.com/watch?v=wmWT9FPdWw0",
      "width": 940,
      "height": 528,
      "thumbnailUrl": "https://i.ytimg.com/vi/wmWT9FPdWw0/hqdefault.jpg",
      "html": "<iframe class=\"embedly-embed\" src=\"//cdn.embedly.com/widgets/media.html?src=https%3A%2F%2Fwww.youtube.com%2Fembed%2FwmWT9FPdWw0%3Ffeature%3Doembed&display_name=YouTube&url=https%3A%2F%2Fwww.youtube.com%2Fwatch%3Fv%3DwmWT9FPdWw0&image=https%3A%2F%2Fi.ytimg.com%2Fvi%2FwmWT9FPdWw0%2Fhqdefault.jpg&key=96f1f04c5f4143bcb0f2e68c87d65feb&type=text%2Fhtml&schema=youtube\" width=\"940\" height=\"528\" scrolling=\"no\" title=\"YouTube embed\" frameborder=\"0\" allow=\"autoplay; fullscreen\" allowfullscreen=\"true\"></iframe>",
      "type": "video"
    }
  ],
  "group": ""
    ...
    <a href="#Second" class="scroll-down w-inline-block">
      <div>Mehr Erfahren</div>
      <div class="crecl-icon-wrapper scroll-down">
        <div class="cercl-figure three withe"><img src="images/sgsf.svg" loading="lazy" width="10" alt=""></div>
      </div>
    </a>
  </section>
  <div id="Second" class="section logo-banner-section wf-section"></div>
  <section class="section blog-section wf-section">
    <div class="container">
      <div class="grid-for-heder-section">
        <div>
          <div class="sub-heding">Was wir machen</div>
          <h3 class="h1">Unsere Dienstleistungen</h3>
        </div>
      </div>
  ...
  <section data-w-id="4c341b8b-2ef7-5a8c-1192-6185da71e66f" class="section wf-section">
    <div class="container">
      <div class="grid-for-heder-section">
        <div>
          <div class="sub-heding">Über Baucampus</div>
          <h2 class="h1">Baucampus – Ihr Vertrauen, unsere Verantwortung.</h2>
        </div>
  ...
  <section class="section our-project wf-section">
    <div class="pading-left-right">
      <div class="container">
        <div class="grid-for-heder-section">
          <div>
      ...
      <div class="tabs-content w-tab-content">
        <div data-w-tab="Tab 1" class="w-tab-pane">
          <div class="grid-for-card-project">
            <a data-w-id="a48f8af6-7921-1c7c-9034-46588ff5f4c6" href="#" class="link-in-card-project w-inline-block">
              <div class="content-for-project-card">
                <div class="all-caps">Current project</div>
                <div class="card-name-text project-section">Pharmaceutical Plant</div>
              </div>
            </a>
            <a data-w-id="1c3b8162-5c6c-cb0b-8701-6b68630c36e3" href="#" class="link-in-card-project w-inline-block">
              <div class="content-for-project-card">
                <div class="all-caps">Current project</div>
                <div class="card-name-text project-section">Data Centre Works</div>
              </div>
            </a>
            <a data-w-id="e6f73f23-22d1-3c35-8da5-cd62cbef127d" href="#" class="link-in-card-project w-inline-block">
              <div class="content-for-project-card">
                <div class="all-caps">Current project</div>
                <div class="card-name-text project-section">Pharmaceutical Plant</div>
              </div>
            </a>
            <a data-w-id="d7a5af19-94d2-8525-3a28-b0fd34148d54" href="#" class="link-in-card-project last w-inline-block">
              <div class="content-for-project-card">
                <div class="all-caps">Current project</div>
                <div class="card-name-text project-section">Pharmaceutical Plant CBSC</div>
              </div>
            </a>
          </div>
        </div>
        <div data-w-tab="Tab 2" class="w-tab-pane">
          <div class="grid-for-card-project current-projects">
            <a data-w-id="5a7dca4f-0666-006d-d050-38c6ddbc6ff1" href="#" class="link-in-card-project w-inline-block">
              <div class="content-for-project-card">
                <div class="all-caps">Current project</div>
                <div class="card-name-text project-section">Data Centre Works,</div>
              </div>
            </a>
            <a data-w-id="5a7dca4f-0666-006d-d050-38c6ddbc6ff7" href="#" class="link-in-card-project w-inline-block">
              <div class="content-for-project-card">
                <div class="all-caps">Current project</div>
                <div class="card-name-text project-section">Pharmaceutical Plant</div>
              </div>
            </a>
            <a data-w-id="5a7dca4f-0666-006d-d050-38c6ddbc6feb" href="#" class="link-in-card-project w-inline-block">
              <div class="content-for-project-card">
                <div class="all-caps">Current project</div>
                <div class="card-name-text project-section">Pharmaceutical Plant</div>
              </div>
            </a>
            <a data-w-id="5a7dca4f-0666-006d-d050-38c6ddbc6ffd" href="#" class="link-in-card-project last w-inline-block">
              <div class="content-for-project-card">
                <div class="all-caps">Current project</div>
                <div class="card-name-text project-section">Pharmaceutical Plant</div>
              </div>
  ...
  <section class="section wf-section">
    <div class="container">
      <div class="grid-for-heder-section">
        <div>
          <div class="sub-heding">Bewertungen</div>
        </div>
      </div>
            ...
            <div class="uui-padding-vertical-xhuge">
              <div class="uui-text-align-center">
                <div class="uui-max-width-large align-center">
                  <h3 class="h1">Was unsere Kunden sagen</h3>
                </div>
              </div>
              <div class="uui-testimonial14_component">
                <div class="uui-testimonial14_content">
                  <div class="uui-testimonial14_rating-wrapper">
                    <div class="uui-testimonial14_rating-icon w-embed"><svg width="20" height="20" viewbox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <div class="uui-heading-xxsmall text-weight-medium">„Der Bausachverständige hat mich sehr beeindruckt. Er war äußerst kompetent, schnell und freundlich. Seine Professionalität war bemerkenswert. Ich kann seine Dienste nur wärmstens empfehlen!“</div>
                ...
                <div class="uui-testimonial14_content">
                  ...
                  <div class="uui-heading-xxsmall text-weight-medium">&quot;Ein seriöser Service, ein erstklassiger Empfang. Ich konnte innerhalb von nur 48 Stunden einen Termin vereinbaren und erhielt einen detaillierten Bericht mit konkreten Hinweisen zu den Verbesserungsvorschlägen in meiner Wohnung, begleitet von Simulationen.&quot;</div>
                  <div class="uui-testimonial14_client">
                ...
                <div class="uui-testimonial14_content">
                  ...
                  <div class="uui-heading-xxsmall text-weight-medium">„Der Bausachverständige war wirklich hervorragend. Er hat seine Arbeit schnell und sehr professionell erledigt. Außerdem war er freundlich und angenehm!“<br><br>‍</div>
                  <div class="uui-testimonial14_client">
                ...
                <div class="uui-testimonial14_content">
                  ...
                  <div class="uui-heading-xxsmall text-weight-medium">„Meine Erfahrung mit diesem Bausachverständigen war ausgezeichnet. Sein Fachwissen ist erstklassig und sein Rat ist von unschätzbarem Wert! Absolut empfehlenswert!! Vielen Dank!“<br><br><br>‍</div>
                  <div class="uui-testimonial14_client">
                ...
                <div class="uui-testimonial14_content">
                  ...
                  <div class="uui-heading-xxsmall text-weight-medium">„Bemerkenswerte Reaktionsfähigkeit. Dieser Experte geht seiner Arbeit mit Leidenschaft nach und scheut keine Mühen, um alle gewünschten Erklärungen zu liefern. Darüber hinaus ist er sehr freundlich.“</div>
                  <div class="uui-testimonial14_client">
                    <div class="uui-testimonial14_client-image-wrapper"><img src="images/thispersondoesnotexist3.jpg" loading="lazy" sizes="48px" srcset="images/thispersondoesnotexist3-p-500.jpg 500w, images/thispersondoesnotexist3-p-800.jpg 800w, images/thispersondoesnotexist3.jpg 1024w" alt="" class="uui-testimonial14_customer-image"></div>
                    <div class="uui-testimonial14_client-info">
                ...
                <div class="uui-testimonial14_content">
                  ...
                  <div class="uui-heading-xxsmall text-weight-medium">„Die Schnelligkeit ist einfach bemerkenswert. Dieser Bausachverständiger geht seiner Arbeit mit Leidenschaft nach und zählt nicht die Stunden, um alle gewünschten Erklärungen zu liefern. Er ist nicht nur sehr kompetent, sondern auch sehr freundlich.“<br>‍</div>
                  <div class="uui-testimonial14_client">
  ...
  <section class="section-for-heading wf-section">
    <div class="container">
      <div>
        <div class="sub-heding">Vier Vorteile, warum ...</div>
        <h3 class="h1">Baucampus beauftragen</h3>
      </div>
    </div>
  </section>
  <div data-w-id="e0095dda-132d-d79a-079e-782cf0f7a456" class="section-step wf-section">
    <div id="w-node-e0095dda-132d-d79a-079e-782cf0f7a457-d9f271bb" class="comtainer relative">
      <div id="w-node-e0095dda-132d-d79a-079e-782cf0f7a458-d9f271bb" class="big-darck-card step-one">
        <div id="w-node-e0095dda-132d-d79a-079e-782cf0f7a459-d9f271bb" class="darck-card-text-wrapper">
          <div class="time-text-wrapper"><img src="images/008-expertise_1008-expertise.png" loading="lazy" alt="" class="icon-main">
            <div id="w-node-e0095dda-132d-d79a-079e-782cf0f7a45c-d9f271bb" class="text-block">Expertise</div>
          </div>
          <h2 class="wite"><strong>Fundiertes Fachwissen</strong></h2>
          <p>Baucampus zeichnet sich durch seine fundierte Sachkenntnis im Immobilienbereich aus. Unsere Experten verfügen über genaue und aktuelle Kenntnisse des Marktes, der Vorschriften und Immobilientrends. Dieses Fachwissen gewährleistet eine genaue Beurteilung und professionelle Beratung bei allen Ihren Immobilienvorhaben und -vorgängen. Wenn Sie mit Baucampus zusammenarbeiten, profitieren Sie von einer Beratung, die auf langjähriger Erfahrung und Praxis in der Branche basiert.</p>
      ...
      <div id="w-node-e0095dda-132d-d79a-079e-782cf0f7a466-d9f271bb" class="big-darck-card step-two">
        <div id="w-node-e0095dda-132d-d79a-079e-782cf0f7a467-d9f271bb" class="darck-card-text-wrapper">
          <div class="time-text-wrapper"><img src="images/002-global-network_1002-global-network.png" loading="lazy" alt="" class="icon-main">
            <div id="w-node-e0095dda-132d-d79a-079e-782cf0f7a46a-d9f271bb" class="text-block-2">Netzwerk</div>
          </div>
          <h2 class="wite"><strong>Breites Netzwerk</strong></h2>
          <p>Baucampus zeichnet sich durch sein umfangreiches Netzwerk an Immobilienexperten aus. Durch die Nutzung von Baucampus haben Sie Zugriff auf ein breites Spektrum an qualifizierten Fachkräften in verschiedenen Bereichen der Immobilienbranche. Ob Sie einen Bewertungsexperten, einen Bausachverständigen oder einen Baubegleiter zur Optimierung Ihres Bauvorhabens benötigen, unser Netzwerk ist für Sie da. Dies ist die Garantie für einen Service, der an Ihre spezifischen Bedürfnisse angepasst ist.</p>
          <div class="dont-dilate_"></div>
      ...
      <div id="w-node-e0095dda-132d-d79a-079e-782cf0f7a474-d9f271bb" class="big-darck-card step-thre">
        <div id="w-node-e0095dda-132d-d79a-079e-782cf0f7a475-d9f271bb" class="darck-card-text-wrapper">
          <div class="time-text-wrapper"><img src="images/010-completed-task_1010-completed-task.png" loading="lazy" alt="" class="icon-main">
            <div id="w-node-e0095dda-132d-d79a-079e-782cf0f7a478-d9f271bb" class="text-block-3">Vollständigkeit</div>
          </div>
          <h2 class="wite"><strong>Komplette Dienstleistungen</strong></h2>
          <p>Schließlich bietet Baucampus ein umfassendes Spektrum an Immobiliendienstleistungen an. Von der Immobilienbewertung und -besichtigung bis hin zu Beratung und Schulung bieten wir ein umfassendes Leistungspaket, um alle Ihre Immobilienerwartungen zu erfüllen. Es ist der Komfort, alle Lösungen, die Sie benötigen, an einem Ort zu finden, ohne mehrere Dienstleister in Anspruch nehmen zu müssen.<br></p>
          <div class="dont-dilate_"></div>
      ...
      <div id="w-node-e0095dda-132d-d79a-079e-782cf0f7a483-d9f271bb" class="big-darck-card step-fore">
        <div id="w-node-e0095dda-132d-d79a-079e-782cf0f7a484-d9f271bb" class="darck-card-text-wrapper">
          <div class="time-text-wrapper"><img src="images/009-quality_1009-quality.png" loading="lazy" alt="" class="icon-main">
            <div id="w-node-e0095dda-132d-d79a-079e-782cf0f7a487-d9f271bb" class="text-block-4">Exzellenz</div>
          </div>
          <h2 class="wite"><strong>Verpflichtung zur Exzellenz</strong></h2>
          <p>Das Streben nach Exzellenz ist eine weitere Stärke von Baucampus. Wir bieten, unseren Kunden Dienstleistungen von höchster Qualität zu bieten, und wir sind ständig bestrebt, unsere Leistung zu verbessern. Unser Ziel ist es, unseren Kunden dabei zu helfen, ihre Immobilienziele mit Integrität, Professionalität und dem unerschütterlichen Wunsch, ihre Erwartungen zu übertreffen, zu erreichen. Exzellenz ist nicht nur unser Ziel, sie ist unser Standard.</p>
          <div class="dont-dilate_"></div>
  ...
  <div data-w-id="81b93628-ea38-0898-c4d5-6a9b91b4bbe0" class="review-section wf-section">
    <div id="w-node-_81b93628-ea38-0898-c4d5-6a9b91b4bbe1-d9f271bb" class="comtainer">
      <div class="banner">
        <div class="quote-grid">
          <div id="w-node-_81b93628-ea38-0898-c4d5-6a9b91b4bbe4-d9f271bb" class="ava-wrapper"><img src="images/qq_pp-1.svg" loading="lazy" alt="" class="small-quote-img"><img src="images/logo.png" loading="lazy" sizes="90px" srcset="images/logo-p-500.png 500w, images/logo-p-800.png 800w, images/logo-p-1080.png 1080w, images/logo.png 1172w" alt="" class="ava"></div>
          <div id="w-node-_81b93628-ea38-0898-c4d5-6a9b91b4bbe7-d9f271bb">
            <div class="quoteblock">Immobilienberatung, Bauherrenbegleitung, Qualitätssicherung. Ist Baucampus auch Ihre Zukunft?</div>
            <div class="ava-name"><strong>Baucampus macht dies möglich!</strong></div>
            <a href="https://baucampus.com" target="_blank" class="button-main margin-top w-button">Baucampus.com</a>
          </div>
        </div>
      </div>
  ...
  <section class="section-about-ethics wf-section">
    <div class="w-container">
      <div class="div-block-2">
        <div class="sub-heding">Ethik &amp; Unternehmen</div>
        <h3 class="h1">Unsere Kultur</h3>
        <p class="paragraph">Bei Baucampus sind wir der Einhaltung höchster ethischer Standards bei allen unseren Geschäftsabwicklungen verpflichtet. Unsere Geschäftsethik basiert auf Integrität, Transparenz und Verantwortung. Wir glauben an Ehrlichkeit und Klarheit im gesamten Umgang mit unseren Kunden, Partnern und Mitarbeitern. Wir sind bestrebt, Dienstleistungen auf eine Weise bereitzustellen, die nicht nur Gesetze und Vorschriften, sondern auch die Rechte und Interessen aller Beteiligten respektiert. Schließlich sind wir der professionellen Exzellenz und der kontinuierlichen Verbesserung verpflichtet, was bedeutet, dass wir ständig danach streben, unsere Servicestandards und Leistung zu verbessern und gleichzeitig unseren ethischen Grundsätzen treu zu bleiben.</p>
        <ul role="list">
          <li>
            <div class="wite"><strong>Integrität:</strong> Seien Sie bei allen geschäftlichen Interaktionen stets ehrlich und transparent. Jede Form von Täuschung oder Manipulation ist zu vermeiden.</div>
          </li>
          <li>
            <div class="wite"><strong>Verantwortung: </strong>Übernehmen Sie Verantwortung für Ihr Handeln und Ihre Entscheidungen und seien Sie bereit, bei Problemen oder Fehlern zur Verantwortung gezogen zu werden.</div>
          </li>
          <li>
            <div class="wite"><strong>Respekt:</strong> Behandeln Sie alle Menschen mit Würde und Respekt, unabhängig von Status, Rasse, Religion, Geschlecht, sexueller Orientierung, Alter oder anderen Merkmalen.</div>
          </li>
          <li>
            <div class="wite"><strong>Privatsphäre: </strong>Respektieren Sie die privaten und vertraulichen Informationen von Kunden, Kollegen und dem Unternehmen.</div>
          </li>
          <li>
            <div class="wite"><strong>Professionalität: </strong>Behalten Sie jederzeit ein professionelles Auftreten und eine professionelle Einstellung bei. Dazu gehört, Verpflichtungen einzuhalten, pünktlich zu sein und qualitativ hochwertige Arbeit zu präsentieren.</div>
          </li>
          <li>
    ...
    <div class="signature-grid butomn">
      <div id="w-node-bb46a7e9-5862-9890-f784-907677d182ef-d9f271bb" class="this-block">
        <div class="icon-wrapper"><img src="images/008-expertise_1008-expertise.png" width="32" alt="" class="icon-main"></div>
        <div><strong>Professionalität</strong></div>
      </div>
      <div id="w-node-c710711c-2541-1ddd-632e-f1188a63e5ff-d9f271bb" class="this-block center">
        <div class="icon-wrapper"><img src="images/006-social-responsibility_1006-social-responsibility.png" height="32" alt="" class="icon-main"></div>
        <div><strong>Respekt</strong></div>
      </div>
      <div id="w-node-_9fd5d7d4-b8af-b11f-3656-f3290d3a2c3c-d9f271bb" class="this-block">
        <div class="icon-wrapper"><img src="images/003-protest_1003-protest.png" height="32" alt="" class="icon-main"></div>
        <div><strong>Gleichberechtigung</strong></div>
      </div>
    </div>
    <div class="signature-grid">
      <div id="w-node-_262ebf9a-9a93-8562-45af-85f9ea4335d7-d9f271bb" class="this-block center">
        <div class="icon-wrapper">
          <div class="icon-wrapper"><img src="images/004-honesty_1004-honesty.png" height="32" alt="" class="icon-main"></div>
        </div>
        <div><strong>Verantwortung</strong></div>
      </div>
      <div id="w-node-_262ebf9a-9a93-8562-45af-85f9ea4335d3-d9f271bb" class="this-block">
        <div class="icon-wrapper"><img src="images/007-integration_1007-integration.png" width="32" alt="" class="icon-main"></div>
        <div><strong>Integrität</strong></div>
      </div>
      <div id="w-node-_262ebf9a-9a93-8562-45af-85f9ea4335db-d9f271bb" class="this-block">
        <div class="icon-wrapper"><img src="images/005-confidentiality_1005-confidentiality.png" width="32" alt="" class="icon-main"></div>
        <div><strong>Privatsphäre</strong></div>
      </div>
    </div>
  </section>
        ...
        <div class="region-card"><img src="images/office2.webp" id="w-node-_329641f7-453d-6aba-3596-018a0e89361c-d9f271bb" sizes="(max-width: 479px) 100vw, (max-width: 767px) 46vw, (max-width: 991px) 47vw, (max-width: 1439px) 28vw, 375.3666687011719px" srcset="images/office2-p-500.webp 500w, images/office2-p-800.webp 800w, images/office2.webp 1024w" alt="" class="img-for-card">
          <a id="w-node-_15d1f59d-95d2-1eff-567b-4170040f9f6f-d9f271bb" href="https://baucampus.com" target="_blank" class="w-inline-block">
            <div id="w-node-a2c9b91e-62bf-8d7d-a5ad-4646c457362d-d9f271bb" class="content-description-card">
              ...
              <p>Mehr über Baucampus und das Partnernetzwerk erfahren!</p>
              <div class="dont-dilate_"></div>
            </div>
          </a>
        </div>
        <div class="region-card"><img src="images/office-f1.webp" id="w-node-ecb86d83-5010-c8a1-8ec8-c87cb8191ddd-d9f271bb" sizes="(max-width: 479px) 100vw, (max-width: 767px) 46vw, (max-width: 991px) 47vw, (max-width: 1439px) 32vw, 406.66668701171875px" srcset="images/office-f1-p-500.webp 500w, images/office-f1-p-800.webp 800w, images/office-f1.webp 1024w" alt="" class="img-for-card">
          <a id="w-node-ebb722fe-880e-b584-ad93-549f6c8fe90a-d9f271bb" href="https://baucampus.at" target="_blank" class="w-inline-block">
            <div id="w-node-ecb86d83-5010-c8a1-8ec8-c87cb8191dde-d9f271bb" class="content-description-card">
              ...
              <p>Mehr über Baucampus in Österreich erfahren!</p>
              <div class="dont-dilate_"></div>
            </div>
          </a>
        </div>
  ...
  <section data-w-id="9ab59575-c0ef-d0eb-9bd1-882e58bbdbe2" class="section wf-section">
    <div class="container">
      <div class="grid-for-heder-section">
