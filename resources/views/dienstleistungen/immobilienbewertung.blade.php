...
<body class="body">
        ...
        <div data-hover="true" data-delay="300" data-w-id="9962d9cc-619f-1e92-7f2b-747f23a8712f" class="navbar-menu-dropdown w-dropdown">
          ...
          <nav class="dropdown-list w-dropdown-list">
            <div class="dropdown-link-list">
              ...
              <a href="../dienstleistungen/immobilienbewertung" aria-current="page" class="dropdown-link w-inline-block w--current">
  ...
  <div data-w-id="6fca50ab-de2f-362b-39cc-d7d7b0ef92d4" class="main-section services wf-section">
    <div class="container relative">
      <h3 data-w-id="d3349579-0b18-6f19-95a4-d1bb8ad22c13" style="opacity:0" class="display-text">Immobilienbewertung</h3>
    </div>
    ...
    <div class="container max-1080-px">
      ...
      <div class="w-layout-grid grid-service-page">
        ...
        <div class="layout-image-wrapper">
          <a href="#" class="lightbox-second-page w-inline-block w-lightbox"><img src="../images/7.png" width="1326" sizes="(max-width: 479px) 91vw, (max-width: 767px) 95vw, (max-width: 1439px) 96vw, 1080px" srcset="../images/7-p-500.png 500w, ../images/7-p-800.png 800w, ../images/7-p-1080.png 1080w, ../images/7.png 1456w" alt="">
