    ...
    <section class="section footer wf-section">
      <div class="container">
        <div class="footer-grid">
          ...
          <p id="w-node-_4aa0d7f3-2a4a-6a6b-69be-35f8e84120fd-e84120df" class="footer-text copyright">© 2023 Baucampus by <a href="https://ariet.is" target="_blank">Arietis </a>- <a href="/impressum" aria-current="page" class="w--current">Impressum</a> - <a href="/datenschutz">Datenschutz</a>
          </p>
