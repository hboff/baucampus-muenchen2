...
<html data-wf-page="648d0891096d52bfd9f271ca" data-wf-site="648d0891096d52bfd9f271dc" lang="fr">
<head>
  <meta charset="utf-8">
  <title>Instruction And Recommendation</title>
  <meta content="Instruction And  Recommendation" property="og:title">
  <meta content="Instruction And  Recommendation" property="twitter:title">
    ...
    <div class="header-section">
      <div class="container-flex">
        <div class="title-wrap-centre">
          <h1 class="style-guide-h1">Instruction And  Recommendation</h1>
        </div>
      </div>
    </div>
        ...
        <div>
          <div class="title-wrap-left">
            <div class="w-richtext">
              <p>This template uses slider and interactions, to better understand how to use sliders in this template, follow this Webflow University <a href="https://university.webflow.com/lesson/slider" target="_blank">link</a>, for understanding interactions you can learn from this Webflow University <a href="https://university.webflow.com/lesson/intro-to-interactions" target="_blank">article</a>
              </p>
            </div>
          </div>
        </div>
