...
<html data-wf-page="648d0891096d52bfd9f271bf" data-wf-site="648d0891096d52bfd9f271dc" lang="fr">
<head>
  <meta charset="utf-8">
    ...
    <div class="header-section">
      <div class="container-flex">
        <div class="title-wrap-centre">
          <h1 class="style-guide-h1">Changelog</h1>
        </div>
      </div>
    </div>
    <div class="content-section">
      <div class="container-tight">
        <div class="background-changelog">
          <div>
            <div class="version-background">
              <div>Template Version 1.0</div>
            </div>
          </div>
          <div>
            <div><strong>The template has been released!</strong></div>
          </div>
        </div>
      </div>
    </div>
